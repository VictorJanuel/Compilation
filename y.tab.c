...
{
       0,    59,    59,    62,    65,    69,    70,    73,    74,    77,
      78,    81,    84,    85,    88,    89,    92,    98,    99,   102,
     105,   106,   109,   112,   113,   116,   119,   120,   123,   124,
     125,   126,   127,   130,   133,   136,   139,   140,   143,   144,
     147,   150,   151,   152,   153,   154,   155,   158,   159,   162,
     165,   166,   169,   170,   173,   176,   182,   185,   190,   191,
     192,   193,   196,   197,   201,   202,   205,   207,   209,   212,
     213,   214,   217,   218,   219,   222,   223,   224,   225,   226,
...
#line 81 "yacc.y" /* yacc.c:1646  */
    {(yyval.arbre).a=(yyvsp[-1].arbre).a;}
#line 1514 "y.tab.c" /* yacc.c:1646  */
    break;

  case 12:
#line 84 "yacc.y" /* yacc.c:1646  */
    {(yyval.arbre).a=concat_fils(creer_noeud(A_LISTE),(yyvsp[-1].arbre).a);}
#line 1520 "y.tab.c" /* yacc.c:1646  */
    break;

  case 13:
#line 85 "yacc.y" /* yacc.c:1646  */
    {(yyval.arbre).a=(yyvsp[-2].arbre); (yyval.arbre).a->fils_gauche=concat_frere((yyval.arbre).a->fils_gauche,concat_fils(creer_noeud(A_LISTE),(yyvsp[-1].arbre).a))}
...
#line 92 "yacc.y" /* yacc.c:1646  */
    {
                              if((yyvsp[0].arbre).type==0){insererDeclaration((yyvsp[-2].arbre).i,N_STRUCT, numchamps);numchamps=0;}
                              else{insererDeclaration((yyvsp[-2].arbre).i,N_TAB, nb_dimensions);nb_dimensions=0; }
                            }
...
#line 99 "yacc.y" /* yacc.c:1646  */
    {(yyval.arbre).type=1;f=enfiler(f, (yyvsp[0].arbre).type);}
#line 1547 "y.tab.c" /* yacc.c:1646  */
    break;

  case 22:
#line 109 "yacc.y" /* yacc.c:1646  */
    {nb_dimensions++;;f=enfiler(f,(yyvsp[-2].arbre).type); f=enfiler(f,(yyvsp[0].arbre).type);}
#line 1553 "y.tab.c" /* yacc.c:1646  */
    break;

  case 25:
#line 116 "yacc.y" /* yacc.c:1646  */
    {numchamps++; f=enfiler(f,(yyvsp[0].arbre).type); f=enfiler(f, (yyvsp[-2].arbre).type);}
#line 1559 "y.tab.c" /* yacc.c:1646  */
    break;

  case 26:
#line 119 "yacc.y" /* yacc.c:1646  */
    {(yyval.arbre).type=(yyvsp[0].arbre).type;}
...
#line 130 "yacc.y" /* yacc.c:1646  */
    {insererDeclaration((yyvsp[-2].arbre).type,N_VAR, numchamps);}
#line 1607 "y.tab.c" /* yacc.c:1646  */
    break;

  case 34:
#line 133 "yacc.y" /* yacc.c:1646  */
    {insererDeclaration((yyvsp[-2].arbre).type,N_PROC, (yyvsp[-1].arbre).type);}
#line 1613 "y.tab.c" /* yacc.c:1646  */
    break;

  case 35:
#line 136 "yacc.y" /* yacc.c:1646  */
    {f=enfiler(f,(yyvsp[-1].arbre).type); insererDeclaration((yyvsp[-4].arbre).type,N_FONC,(yyvsp[-3].arbre).type);}
...
#line 140 "yacc.y" /* yacc.c:1646  */
    {(yyval.arbre).type=nb_params; nb_params=0;}
#line 1631 "y.tab.c" /* yacc.c:1646  */
    break;

  case 40:
#line 147 "yacc.y" /* yacc.c:1646  */
    {nb_params++; f=enfiler(f, (yyvsp[0].arbre).type); f=enfiler(f,(yyvsp[-2].arbre).type);}
...
#line 176 "yacc.y" /* yacc.c:1646  */
    {(yyval.arbre).a=creer_arbre(A_SI,A_EMPTY_LEX,A_EMPTY_DEC,concat_frere(concat_fils(creer_noeud(A_LISTE_IF,A_EMPTY_LEX,A_EMPTY_DEC),(yyvsp[-2].arbre).a),concat_fils(creer_noeud(A_LISTE_ELSE,A_EMPTY_LEX,A_EMPTY_DEC),(yyvsp[0].arbre).a)));
...
#line 182 "yacc.y" /* yacc.c:1646  */
    {(yyval.arbre).a=creer_arbre(A_WHILE,A_EMPTY_LEX,A_EMPTY_DEC,(yyvsp[-2].arbre).a,(yyvsp[0].arbre).a);}
#line 1664 "y.tab.c" /* yacc.c:1646  */
    break;

  case 57:
#line 185 "yacc.y" /* yacc.c:1646  */
    {(yyval.arbre).a=creer_arbre(A_AFFECT,A_EMPTY_LEX,A_EMPTY_DEC,(yyvsp[-2].arbre).a,(yyvsp[0].arbre).a);
...
#line 190 "yacc.y" /* yacc.c:1646  */
    {creer_noeud(A_IDF,(yyvsp[0].arbre),assoc_nom((yyvsp[0].arbre)));}
#line 1678 "y.tab.c" /* yacc.c:1646  */
    break;

  case 59:
#line 191 "yacc.y" /* yacc.c:1646  */
    {creer_noeud(A_IDF,(yyvsp[-1].arbre),assoc_nom((yyvsp[-1].arbre)));}
#line 1684 "y.tab.c" /* yacc.c:1646  */
    break;

  case 60:
#line 192 "yacc.y" /* yacc.c:1646  */
    {creer_noeud(A_IDF,(yyvsp[-2].arbre),assoc_nom((yyvsp[-2].arbre)));}
#line 1690 "y.tab.c" /* yacc.c:1646  */
    break;

  case 61:
#line 193 "yacc.y" /* yacc.c:1646  */
    {creer_noeud(A_IDF,(yyvsp[-3].arbre),assoc_nom((yyvsp[-3].arbre)));}
...
#line 205 "yacc.y" /* yacc.c:1646  */
    {(yyval.arbre)=creer_arbre(A_PLUS,A_EMPTY_LEX,A_EMPTY,(yyvsp[-2].arbre),(yyvsp[0].arbre));}
#line 1714 "y.tab.c" /* yacc.c:1646  */
    break;

  case 67:
#line 207 "yacc.y" /* yacc.c:1646  */
    {(yyval.arbre)=creer_arbre(A_MOINS,A_EMPTY_LEX,A_EMPTY,(yyvsp[-2].arbre),(yyvsp[0].arbre));}
...
#line 212 "yacc.y" /* yacc.c:1646  */
    {creer_arbre(A_MULT,A_EMPTY_LEX,A_EMPTY_DEC,(yyvsp[-2].arbre),(yyvsp[0].arbre))}
#line 1732 "y.tab.c" /* yacc.c:1646  */
    break;

  case 70:
#line 213 "yacc.y" /* yacc.c:1646  */
    {creer_arbre(A_DIV,A_EMPTY_LEX,A_EMPTY_DEC,(yyvsp[-2].arbre),(yyvsp[0].arbre))}
...
#line 224 "yacc.y" /* yacc.c:1646  */
    {(yyval.arbre).a=creer_noeud(A_CSTE_E,A_EMPTY_LEX,A_EMPTY_DEC); (yyval.arbre).i=(yyvsp[0].arbre).i;}
#line 1780 "y.tab.c" /* yacc.c:1646  */
    break;

  case 78:
#line 225 "yacc.y" /* yacc.c:1646  */
    {(yyval.arbre).a=creer_noeud(A_CSTE_R,A_EMPTY_LEX,A_EMPTY_DEC); (yyval.arbre).f=(yyvsp[0].arbre).f;}
#line 1786 "y.tab.c" /* yacc.c:1646  */
    break;

  case 79:
#line 226 "yacc.y" /* yacc.c:1646  */
    {(yyval.arbre).a=creer_noeud(A_CSTE_C,A_EMPTY_LEX,A_EMPTY_DEC); (yyval.arbre).c = (yyvsp[0].arbre).c;}
#line 1792 "y.tab.c" /* yacc.c:1646  */
    break;

  case 80:
#line 227 "yacc.y" /* yacc.c:1646  */
    {(yyval.arbre).a=creer_noeud(A_CSTE_S,A_EMPTY_LEX,A_EMPTY_DEC);}
#line 1798 "y.tab.c" /* yacc.c:1646  */
    break;

  case 81:
#line 230 "yacc.y" /* yacc.c:1646  */
    {(yyval.arbre).a=creer_arbre(A_OU,A_EMPTY_LEX,A_EMPTY}
...
#line 234 "yacc.y" /* yacc.c:1646  */
    {(yyval.arbre).a=creer_arbre(A_ET,A_EMPTY_LEX,A_EMPTY_DECLA,(yyvsp[-2].arbre).a,(yyvsp[0].arbre).a);}
...
#line 243 "yacc.y" /* yacc.c:1646  */
    {(yyval.arbre).a=creer_noeud(A_TRUE,A_EMPTY_LEX,A_EMPTY_DEC);}
#line 1846 "y.tab.c" /* yacc.c:1646  */
    break;

  case 89:
#line 244 "yacc.y" /* yacc.c:1646  */
    {(yyval.arbre).a=creer_noeud(A_FALSE,A_EMPTY_LEX,A_EMPTY_DEC);}
...
#line 248 "yacc.y" /* yacc.c:1646  */
    {(yyval.arbre).a=creer_arbre(A_EG,A_EMPTY_LEX,A_EMPTY_DEX,(yyvsp[-2].arbre).a,(yyvsp[0].arbre).a);}
#line 1864 "y.tab.c" /* yacc.c:1646  */
    break;

  case 92:
#line 249 "yacc.y" /* yacc.c:1646  */
    {(yyval.arbre).a=creer_arbre(A_INF,A_EMPTY_LEX,A_EMPTY_DEX,(yyvsp[-2].arbre).a,(yyvsp[0].arbre).a);}
#line 1870 "y.tab.c" /* yacc.c:1646  */
    break;

  case 93:
#line 250 "yacc.y" /* yacc.c:1646  */
    {(yyval.arbre).a=creer_arbre(A_SUP,A_EMPTY_LEX,A_EMPTY_DEX,(yyvsp[-2].arbre).a,(yyvsp[0].arbre).a);}
#line 1876 "y.tab.c" /* yacc.c:1646  */
    break;

  case 94:
#line 251 "yacc.y" /* yacc.c:1646  */
    {(yyval.arbre).a=creer_arbre(A_INF_EG,A_EMPTY_LEX,A_EMPTY_DEX,(yyvsp[-2].arbre).a,(yyvsp[0].arbre).a);}
#line 1882 "y.tab.c" /* yacc.c:1646  */
    break;

  case 95:
#line 252 "yacc.y" /* yacc.c:1646  */
    {(yyval.arbre).a=creer_arbre(A_SUP_EG,A_EMPTY_LEX,A_EMPTY_DEX,(yyvsp[-2].arbre).a,(yyvsp[0].arbre).a);}
#line 1888 "y.tab.c" /* yacc.c:1646  */
    break;

  case 96:
#line 253 "yacc.y" /* yacc.c:1646  */
    {(yyval.arbre).a=creer_arbre(A_DIFF,A_EMPTY_LEX,A_EMPTY_DEX,(yyvsp[-2].arbre).a,(yyvsp[0].arbre).a);}
