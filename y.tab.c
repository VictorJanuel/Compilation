...
{
       0,    36,    36,    54,    73,    77,    78,    81,    82,    85,
      86,    89,   108,   109,   112,   113,   116,   122,   123,   126,
     129,   130,   133,   136,   137,   140,   143,   144,   147,   148,
     149,   150,   151,   154,   157,   160,   163,   164,   167,   168,
     171,   174,   175,   176,   177,   178,   179,   182,   183,   186,
     205,   206,   209,   210,   213,   216,   235,   254,   283,   284,
     285,   286,   289,   290,   294,   295,   298,   315,   332,   335,
     342,   349,   352,   353,   354,   357,   358,   359,   360,   361,
     362,   365,   366,   369,   370,   373,   374,   377,   378,   379,
...
#line 116 "yacc.y" /* yacc.c:1646  */
    {
    if((yyvsp[0])==0){insererDeclaration((yyvsp[-2]),N_STRUCT, numchamps, -1);numchamps=0;}
    else{insererDeclaration((yyvsp[-2]),N_TAB, nb_dimensions, -1);nb_dimensions=0; }
                            }
...
#line 154 "yacc.y" /* yacc.c:1646  */
    {insererDeclaration((yyvsp[-2]),N_VAR, numchamps, (yyvsp[0]));}
#line 1614 "y.tab.c" /* yacc.c:1646  */
    break;

  case 34:
#line 157 "yacc.y" /* yacc.c:1646  */
    {insererDeclaration((yyvsp[-2]),N_PROC, (yyvsp[-1]),  -1);}
#line 1620 "y.tab.c" /* yacc.c:1646  */
    break;

  case 35:
#line 160 "yacc.y" /* yacc.c:1646  */
    {f=enfiler(f,(yyvsp[-1])); insererDeclaration((yyvsp[-4]),N_FONC,(yyvsp[-3]), -1);}
...
#line 171 "yacc.y" /* yacc.c:1646  */
    {insererDeclaration((yyvsp[-2]), N_PARAM, numchamps, (yyvsp[0])); nb_params++; f=enfiler(f, (yyvsp[0])); f=enfiler(f,(yyvsp[-2]));}
